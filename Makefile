...
ifeq (${TARGET},local)
	...
	CGO_ENABLED=0 GOFLAGS="-gcflags=-trimpath=${GOPATH} -asmflags=-trimpath=${GOPATH}" GOOS=linux go build -trimpath -ldflags "-s -w"  -o nginx-ns1-gslb github.com/nginxinc/nginx-ns1-gslb/cmd/agent
endif
